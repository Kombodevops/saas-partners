...
export default function RestauranteDatosFiscalesPage({ params }: PageProps) {
  ...
  const getContractBlocks = (values: RestauranteFiscalForm) => {
    ...
    const lines: { text: string; bold?: boolean }[] = [
      ...
      { text: '7. Marco legal adicional y documentación contractual', bold: true },
      { text: 'La relación entre las partes se regirá, además de por lo dispuesto en el presente Contrato, por lo establecido en los siguientes documentos, que forman parte integrante del ecosistema contractual de la Plataforma:' },
      { text: 'El Acuerdo de Encargo de Tratamiento de Datos (Data Processing Agreement o DPA)' },
      { text: 'La Política de Privacidad de la Plataforma' },
      { text: 'Los Términos y Condiciones de uso de Komvo' },
      { text: 'En caso de contradicción, dichos documentos prevalecerán en lo relativo a su materia específica.' },
      { text: 'El Establecimiento declara haber leído, comprendido y aceptado dichos documentos, obligándose a su cumplimiento en todo aquello que le resulte de aplicación.' },
